                        ...
                        <div class="d-flex">
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="d-flex me-6">
                                    <img src="cdn/img/company-lighthouse.svg" class="rounded-circle img-overlap" width="48" height="48">
                                </div>
                                <div>
                                    <div class="fs-3 fw-semibold text-truncate">Lighthouse Stats</div>
                                    <div class="text-muted fs-5 lh-1 d-flex">
                                        <div>Earn points</div>
                                        <div class="mx-3">•</div>
                                        <div>Unlock $LHT</div>
                                        <div class="mx-3">•</div>
