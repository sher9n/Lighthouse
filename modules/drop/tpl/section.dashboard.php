                ...
                <div class="card shadow mb-12 loading position-relative">
                    <div class="card-body pt-18">
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <div>
                                <div class="text-content-xxxl mb-6 mw-180"></div>
                                <div class="rounded-pill text-content-xxxxl w-70"></div>                                
                            </div>
                        </div>
                        <div class="my-17 three-line-text-content"></div>
                        <div class="text-content-xxxxxl m-auto w-80"></div>
                        <div class="mt-2 text-content-xxl m-auto w-20"></div>
                        <div class="text-content-xs m-8"></div>
                        <div class="text-content-xxl m-auto w-30 mb-10"></div>                    
                        <div class="mt-12">
                            <div class="text-content-xxxl mb-5"></div>
                            <div class="text-content-xxxl mb-5"></div>
                        </div>    
                    </div>
                    <div class="dash-divider"></div>
                    <div class="card-body text-center pt-6 pb-18">
                        <div class="mb-10 text-content-lg w-20 m-auto"></div>
                        <div class="btn-content-lg m-auto w-30 rounded"></div>
                    </div>
                </div>
            </div>
        </div>
