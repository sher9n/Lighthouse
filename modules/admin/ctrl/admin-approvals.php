...
class controller extends Ctrl {
    function init() {
        ...
        if($this->__lh_request->is_xmlHttpRequest) {
            ...
            if(__ROUTER_PATH == '/claim-details' && $this->getParam('claim_id')) {
            ...
            $claims = Claim::find("SELECT c.id as c_id,c.clm_tags,c.c_at,com.wallet_adr,com.id as com_id FROM claims c LEFT JOIN communities com ON c.comunity_id=com.id WHERE com.dao_domain='$domain'");
