        ...
        <div class="col-lg-6 bg-white">
            <form id="claimForm" method="post" action="claim-reason" autocomplete="off" class="d-flex flex-column h-100">
                <div class="px-26">
                    ...
                    <div class="fs-3 mt-12">To view nt<?php echo $__page->claim->ticker; ?> in your wallet, add the contract below.</div>
                    <div class="mt-12">
                    ...
                    <div class="mt-16">
                        ...
                        <div class="d-flex align-items-center"><span class="fw-medium fs-3 text-break"><?php echo $__page->claim->token_address; ?></span><i data-feather="copy" class="ms-3 text-primary"></i></div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", '#btn_add_metamask', function(event) {
            ...
            var element = $(this);
            addTokenFunction(<?php echo $__page->claim->token_address; ?>,<?php echo $__page->claim->ticker; ?>);
        });
