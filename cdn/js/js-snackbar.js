function SnackBar(userOptions) {
  ...
  function _createMessage() {
    ...
    function applyColorAndIconTo(element) {
      ...
      applyColorTo(status, element);
      applyIconTo(status, element);
      element.appendChild(status);

      function applyColorTo(element, innerSnack) {
        switch (_Options.status) {
          case "success":
          case "green":
            innerSnack.classList.add("js-snackbar--success--outer");
          ...
          case "alert":
          case "orange":
            innerSnack.classList.add("js-snackbar--warning--outer");
          ...
          case "error":
          case "red":
            innerSnack.classList.add("js-snackbar--danger--outer");
            element.classList.add("js-snackbar--danger");
            break;

          default:
            innerSnack.classList.add("js-snackbar--info--outer");
            element.classList.add("js-snackbar--info");
            break;
        }
      }

      function applyIconTo(element, innerSnack) {
