...
gj.picker.methods = {
    ...
    initialize: function ($input, data, methods) {
        ...
        if (data.uiLibrary === 'bootstrap') {
            ...
            $rightIcon = $('<button class="btn btn-athens-gray border-0" type="button">' + data.icons.rightIcon + '</button>');
        } else {
...
gj.datepicker.config = {
    ...
    fontawesome: {
        icons: {
            ...
            rightIcon: '<i data-feather="calendar" class="text-dove-gray"></i>',
            previousMonth: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left text-dove-gray"><polyline points="15 18 9 12 15 6"></polyline></svg>',
            nextMonth: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right text-dove-gray"><polyline points="9 18 15 12 9 6"></polyline></svg>'
        }
    },
