...
try {
    ...
    $localRoutes = array(
        ...
        '/cron-default-forms' => 'modules/crons/defult_forms.php',
        ...
        '/approvals' => 'modules/admin/ctrl/admin-approvals.php',
        ...
        '/execute-admin-proposal' => 'modules/admin/ctrl/admin-stewards.php',
        '/execute-quorum-proposal' => 'modules/admin/ctrl/admin-stewards.php',
        '/execute-log-proposal' => 'modules/admin/ctrl/admin-approvals.php',
        '/add-stewards' => 'modules/admin/ctrl/admin-stewards.php',
        '/edit-steward' => 'modules/admin/ctrl/admin-stewards.php',
        '/stewards' => 'modules/admin/ctrl/admin-stewards.php',
        '/vote-proposal' => 'modules/admin/ctrl/admin-stewards.php',
        '/vote-log-proposal' => 'modules/admin/ctrl/admin-approvals.php',
