...
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/jquery.form.min.js"></script>
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/jquery.validate.min.js"></script>
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/popper.min.js"></script>
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/select2.full.min.js"></script>
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/js-snackbar.js"></script>
<!--Wallet connect JS-->
...
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/wallet.connect.admin.js"></script>
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/connect-solana.admin.js"></script>
<?php
