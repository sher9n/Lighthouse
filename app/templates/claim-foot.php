...
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/wallet.connect.js"></script>
<script type="text/javascript" src="<?php echo app_local_cdn_path; ?>js/connect-solana.claim.js"></script>
<?php
