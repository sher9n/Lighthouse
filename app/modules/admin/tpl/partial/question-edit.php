                ...
                <div class="dropdown">
                    <button class="btn btn-lg dropdown-toggle d-flex justify-content-between align-items-center text-transform-inherit fw-medium w-100 border rounded-1"
                        ...
                        <div  class="d-flex align-items-center text-dark">
                           ...
                           <?php } elseif ($element['e_type'] == Form::QT_DATE) { ?>
                           ...
                           <?php } elseif ($element['e_type'] == Form::QT_FILE_UPLOAD) { ?>
                               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li class="border-bottom">
                            <a class="dropdown-item d-flex align-items-center py-6  px-12 question_type" data-rowindex="<?php echo $row_id; ?>" data-val="<?php echo Form::QT_DATE; ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                     class="feather feather-calendar me-6">
                                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                                    <line x1="16" y1="2" x2="16" y2="6"></line>
                        ...
                        <li class="">
                            <a class="dropdown-item d-flex align-items-center py-6  px-12 question_type" data-rowindex="<?php echo $row_id; ?>" data-val="<?php echo Form::QT_FILE_UPLOAD; ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                     class="feather feather-upload me-6">
                                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                                    <polyline points="17 8 12 3 7 8"></polyline>
        ...
        <div class="description_row">
                        ...
                        <div class="row mb-6">
                            <div class="col-10 col-xxl-11">
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="description_<?php echo $row_id; ?>" name="description[<?php echo $row_id; ?>][]"
                                           aria-describedby=""
                                           placeholder="Add option" value="<?php echo $des; ?>">
                                </div>
                            </div>
                            <?php if($index != 0){ ?>
                            <div class="col px-0">
                        ...
                        <div class="row mb-6">
                            <div class="col-10 col-xxl-11">
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-control form-control-lg"  id="description_<?php echo $row_id; ?>" name="description[<?php echo $row_id; ?>][]"
                                           aria-describedby="" placeholder="Add option" value="<?php echo $des; ?>">
                                </div>
                            </div>
                            <?php if($index != 0){ ?>
                            <div class="col px-0">
            ...
            <div class="q_description" id="q_type_<?php echo Form::QT_FILE_UPLOAD; ?>">
                ...
                <input type="text" class="form-control form-control-lg" id="description_<?php echo $row_id; ?>1" name="description[<?php echo $row_id; ?>]"
                       placeholder="<?php echo $element['e_description']; ?>">
            </div>
            <?php } elseif ($element['e_type'] == Form::QT_DATE) { ?>
