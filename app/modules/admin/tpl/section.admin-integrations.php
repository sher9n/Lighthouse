                      ...
                      <div class="col-xl-6">
                        <div class="card border rounded-3 mb-12">
                          <div class="card-body">
                            ...
                            <div class="fw-medium lh-lg two-lines-wrap text-gray-700">Direct proof of "Skin in the Game" for every community member.</div>
                          </div>
                          <div class="border-top card-body text-end">
                            <a href="#" class="fw-medium text-decoration-none text-blue-stone">Coming Soon!</a>
                          </div>
                      ...
                      <div class="col-xl-6">
                        <div class="card border rounded-3 mb-12">
                          <div class="card-body">
                            ...
                            <div class="fw-medium lh-lg two-lines-wrap text-gray-700">An integrated permissioning tool that helps businesses control access to their dApps.</div>
                          </div>
                          <div class="border-top card-body text-end">
                            <a href="#" class="fw-medium text-decoration-none text-blue-stone">Coming Soon!</a>
                          </div>
                      ...
                      <div class="col-xl-6">
                        <div class="card border rounded-3 mb-12">
                          <div class="card-body">
                            ...
                            <div class="fw-medium lh-lg two-lines-wrap text-gray-700">These non-transferable tokens are automatically awarded and revoked based on a member's percentile.</div>
                          </div>
                          <div class="border-top card-body">
                            <div class="d-flex justify-content-between align-items-center">
                              <div class="fw-medium"><sapn class="text-gray-700">Developed by: </sapn>Lighthouse</div>
                              <a href="#" class="fw-medium text-decoration-none text-primary" data-bs-toggle="modal" data-bs-target="#SetupNTTsModal">Setup NTTs</a>
                            </div>                            
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-6">
                        <div class="card border rounded-3 mb-12">
                          <div class="card-body">
                            ...
                            <div class="fw-medium lh-lg two-lines-wrap text-gray-700">Mint and distribute non-transferrable tokens to your community.</div>
                          </div>
                          <div class="border-top card-body">
                            <div class="d-flex justify-content-between align-items-center">
                              <div class="fw-medium"><sapn class="text-gray-700">Developed by: </sapn>Lighthouse</div>
                      ...
                      <div class="col-xl-6">
                        <div class="card border rounded-3 mb-12">
                          <div class="card-body">
                            ...
                            <div class="fw-medium lh-lg two-lines-wrap text-gray-700">Airdrop tokens to your community based on active participation.</div>
                          </div>
                          <div class="border-top card-body">
                            <div class="d-flex justify-content-between align-items-center">
                              <div class="fw-medium"><sapn class="text-gray-700">Developed by: </sapn><?php echo ($__page->blockchain == 'SOLANA')?'Streamflow':'SuperFluid'; ?></div>
...
<!-- Modal Setup NTTs-->
<div class="modal fade" id="SetupNTTsModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-size-02">
    <div class="modal-content">
      <div class="modal-body">
